...
\subsection{Purpose}
The Software Design Document describes the architecture and system design for Infrastructure Degradation Management Platform, a mobile and web application for documenting infrastructure issues. The Infrastructure Degradation Management Platform is designed to help residents report infrastructure problems and hold property associations accountable. This document is intended for Project Managers, Software Engineers, and anyone else who will be involved in the implementation of the system.
