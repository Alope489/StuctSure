...
\hline
1.0 & \raggedright Andres Stephen Lopez\\ Nicole Fonseca\\ Logan Pritchard\\ Grace Hechavarria & Initial Release & \today \\
\hline
\end{tabular}
\end{table}
...
\begin{itemize}
    ...
    \item Cursor IDE: https://cursor.sh/ - AI-powered code editor used for development and documentation
    \item Anthropic Claude (via Cursor): Large Language Model AI assistant used for code generation, documentation, and design assistance throughout the project
    \item LaTeX Project: https://www.latex-project.org/ - Document preparation system used for creating this Software Design Document
\end{itemize}
